...
export const CANDIDATE_LISTINGS: CandidateListing[] = [
  ...
  { id: "candidate_demo_03", name: "许知远", role: "AI 产品经理 · Agent 方向", image: "/images/candidates/candidate-editorial-02.png", location: "深圳 · 可远程", experience: "应届生", education: "中山大学 · 硕士", intro: "能快速搭建 Agent 原型，正在把实验项目打磨成可访问的作品。", tags: ["Agent", "RAG", "原型开发"], projects: ["研究助手 Agent：用 RAG 串起检索、引用和复盘。", "多轮对话 Demo：完成意图识别与人工接管。"], resume: ["教育：软件工程", "经历：实验室 AI 应用研究", "作品：两个可运行 Demo"], availability: "随时可沟通" },
  { id: "candidate_demo_04", name: "唐可", role: "AI 用户体验设计师", image: "/images/candidates/candidate-editorial-03.png", location: "广州 · 可到岗", experience: "2年", education: "广州美术学院 · 本科", intro: "关注 AI 产品里的信任感和可理解性，用原型验证体验取舍。", tags: ["交互设计", "用户测试", "Design System"], projects: ["智能客服工作台：重做 Agent 状态和人工接管体验。", "AI 写作工具：通过 12 次测试优化提示反馈。"], resume: ["教育：数字媒体艺术", "经历：SaaS 体验设计师", "作品：AI 工作流体验案例"], availability: "一个月内到岗" },
  { id: "candidate_demo_05", name: "沈川", role: "AI 解决方案顾问", image: "/images/candidates/candidate-editorial-02.png", location: "成都 · 可出差", experience: "3年", education: "电子科技大学 · 本科", intro: "擅长把客户的模糊问题拆成指标、流程和可验证的方案。", tags: ["解决方案", "业务分析", "客户成功"], projects: ["零售预测项目：和客户定义指标并跟进落地。", "企业知识库：完成从调研到交付的方案沉淀。"], resume: ["教育：工业工程", "经历：企业数字化咨询", "作品：客户问题到方案的案例集"], availability: "两周内到岗" },
  { id: "candidate_demo_06", name: "顾南", role: "AI 产品实习生", image: "/images/candidates/candidate-editorial-01.png", location: "杭州 · 在校", experience: "应届生", education: "浙江大学 · 本科", intro: "有内容工具和增长实验经验，希望在真实团队里继续做出可验证的结果。", tags: ["内容产品", "增长实验", "数据复盘"], projects: ["校园内容工具：用访谈和数据完成三次迭代。", "AI 阅读卡片：从原型到 300 人内测。"], resume: ["教育：新闻传播学", "经历：内容平台产品实习", "作品：增长实验复盘"], availability: "可实习 6 个月" },
];
